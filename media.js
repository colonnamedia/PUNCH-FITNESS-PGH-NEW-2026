...
(function () {
  ...
  function enhanceAdReels(){
    ...
    style.textContent = `
      ...
      #plp .ad-reels-panel{max-width:1320px;margin:0 auto;background:#fff;border:1px solid #ded8ce;border-radius:22px;padding:48px 0 34px;box-shadow:0 14px 42px rgba(0,0,0,.06);overflow:hidden}
      ...
      #plp .ad-reels-showcase .reels-strip{display:flex!important;grid-template-columns:none!important;gap:18px!important;overflow-x:auto!important;overflow-y:hidden!important;scroll-snap-type:x mandatory!important;scroll-padding-left:max(28px,calc((100vw - 1320px)/2 + 28px));padding:4px max(28px,calc((100vw - 1320px)/2 + 28px)) 18px!important;-webkit-overflow-scrolling:touch;overscroll-behavior-x:contain;scrollbar-width:none}
      #plp .ad-reels-showcase .reels-strip::-webkit-scrollbar{display:none}
      #plp .ad-reels-showcase .reels-strip>div{flex:0 0 clamp(310px,29vw,390px)!important;width:clamp(310px,29vw,390px)!important;scroll-snap-align:start;background:#111;border-radius:18px;overflow:hidden;box-shadow:0 10px 26px rgba(0,0,0,.14)}
      ...
      @media(max-width:760px){
        ...
        #plp .ad-reels-panel{border-radius:0;border-left:0;border-right:0;padding:38px 0 24px}
        #plp .ad-reels-panel>.si:first-child{padding:0 20px!important;margin-bottom:24px!important}
        #plp .ad-reels-showcase .reels-strip{gap:14px!important;padding:4px 20px 16px!important;scroll-padding-left:20px!important}
        #plp .ad-reels-showcase .reels-strip>div{flex-basis:min(82vw,370px)!important;width:min(82vw,370px)!important}
